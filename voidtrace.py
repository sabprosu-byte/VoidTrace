...
def ghost_track_number_recon():
    ...
    ========================================
    """)
    raw_number = input("Enter phone number target Ex [+6281xxxxxxxxxx] : ").strip()
    
    try:
        parsed_number = phonenumbers.parse(raw_number)
        
        if not phonenumbers.is_valid_number(parsed_number):
            print("\n[!] Uyarı: Girilen numara standartlara göre geçerli görünmüyor ama yine de analiz ediliyor...\n")
        ...
        type_str = "This is a mobile number" if number_type == phonenumbers.PhoneNumberType.MOBILE else "Other line type (Fixed/VoIP/etc)"
